...
const { xnoToByteArray, xnoPowHash, xnoPowTest } = require('./xno-data-tools-pow-common');

exports.xnoToByteArray = xnoToByteArray;
exports.xnoPowHash = xnoPowHash;
exports.xnoPowTest = xnoPowTest;
/**
...
/**
 * Find 8 byte proof of work nonce for a block hash. Uses workers, nodejs and browserify compatible.
 ...
 */
exports.xnoPow = async function(hash, threshold, c, callback, limit) {
...
exports.nTools = function(config) {
	...
	this.buildReceiveBlock = async function(block, privateKey) {
        	let promise = new Promise(async (resolve, reject) => {
                	...
                	let nonced = await xnoPow((genesis == true) ? publicKey : receiverAccount.frontier, 'fffffe0000000000', (async () => {
